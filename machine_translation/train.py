...
def prepare_data(raw_data=raw_data):
    input_lang = Lang("keywords")
...
def trainIters(encoder, decoder, n_iters, save_print_every=1000, plot_every=100, learning_rate=0.01):
    start = time.time()
    plot_losses = []
    ...
    for iter in tqdm(range(1, n_iters + 1)):
        ...
        if iter % save_print_every == 0:
            print_loss_avg = print_loss_total / save_print_every
            print_loss_total = 0
...
trainIters(encoder1, attn_decoder1, 75000, save_print_every=5000)